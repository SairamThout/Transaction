...
export default function Jump_Buttons(props) {
    return (
        <div className="buttons">
            ...
            <div>
                <button onClick={() => { props.setpage(Math.ceil(props.trans.length/props.row));}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-skip-forward" viewBox="0 0 16 16">
